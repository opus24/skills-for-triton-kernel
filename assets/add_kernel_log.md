...
### 상세 정보
- 테스트 Shape: (32, 64), (128, 256), (256, 512), (1024, 2048), (1, 100)
...
|--------|------------|-------------|------------|------------|------------------|
| v1_baseline | 0.0064 | 0.0264 | 0.3639 | 0.1322 | 1.00x |
| v2_tiling | 0.0062 | 0.0267 | 0.3531 | 0.1287 | 1.03x |
| v3_coalesced | 0.0061 | 0.0261 | 0.3639 | 0.1320 | 1.00x |
| v4_optimized | 0.0062 | 0.0258 | 0.3543 | 0.1288 | 1.03x |
| torch (baseline) | 0.0066 | 0.0263 | 0.3642 | 0.1324 | 1.0x |
...
### 선정 이유
v2_tiling이 최저 평균 실행 시간(0.1287 ms)을 기록하여 최적 커널로 선정되었습니다. v4_optimized와 거의 동일한 성능(0.1288 ms)을 보이지만, v2_tiling이 더 간단한 구현으로 동일 수준의 성능을 달성했습니다.
